...
<body>
  ...
  foreach ($lineas as $linea) {
    ...
    if ($i != 0) {
      ...
      $que_podemos_escalar= utf8_encode(trim($datos[1]));
      $descripcion = utf8_encode(trim($datos[2]));
      $ans= utf8_encode(trim($datos[3]));
      $url1= utf8_encode(trim($datos[4]));



      $sqlInsertPersona = ("INSERT INTO datos1(nombre, que_podemos_escalar, descripcion, ans, url1) 
      VALUES('$nombre','$que_podemos_escalar','$descripcion' ,'$ans', '$url1')");
